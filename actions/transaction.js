...
export async function createTransaction(data) {
  try {
    ...
    if (data.type === "EXPENSE") {
      await queueBudgetAlertCheck(user.id, data.accountId);
    }
...
async function queueBudgetAlertCheck(userId, accountId) {
  try {
    await inngest.send({
    ...
    console.error("Failed to queue budget alert check:", error);
  }
}
